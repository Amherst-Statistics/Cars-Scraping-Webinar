...
\item The ``Less Volume, More Creativity" approach utilized by the {\tt mosaic} and {\tt ggformula} packages facilitates the analysis with a minimal amount of syntax. 
...
\item How much does it cost to drive a car one mile?
\end{itemize}
}
...
\item[Software] R/RStudio and Excel, Open Office, or Google Spreadsheet
...
\item Fit regression model and report coefficients
\item Scaffolding for additional analyses by the group
\end{itemize}
}
...
\frame{
\frametitle{Examples}
\includegraphics[scale=0.59]{images/cars-scat.png}
}
...
\frame{
\frametitle{Cars.com followup}
\includegraphics[scale=0.82]{images/cars-reg.png}
}
...
\begin{itemize}
\item Interpreting this model as an exam question
\item Residual diagnostics
\item Functional form of relationship (non-linear?)
...
\begin{itemize}
\item Teach statistics as an investigative process of problem-solving and decision-making.
\item {\bf Give students experience with \emph{multivariable thinking}.}
\end{itemize}
\item Focus on conceptual understanding.
\item {\bf Integrate real data with a context and purpose.}
\item {\bf Foster active learning.}
\item {\bf Use technology to explore concepts and analyze data.}
\item Use assessments to improve and evaluate student learning.
\end{enumerate}
}
